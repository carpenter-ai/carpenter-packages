"""
Minimal acceptance-story framework for carpenter-imap-email package-internal
stories.
...
def package_root() -> Path:
    """Return the carpenter-imap-email package directory (parent of
    ``user_stories/``).
    """
...
def load_package_module(name: str):
    """Import a sibling module from this carpenter-imap-email package via the
    ...
    return _import_package_module(
        "carpenter-imap-email", name, package_root(),
    )
